#!/usr/bin/env python3
"""Prepare and audit the Large-scale wood surface defects dataset."""
...
from src.datasets.large_scale_dataset import parse_large_scale_dataset
...
def main() -> None:
    ...
    logger.info("Preparing large-scale dataset from %s", config.get("root_dir"))
    records, report = parse_large_scale_dataset(config)
